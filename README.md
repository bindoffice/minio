...
[![bind-store](https://raw.githubusercontent.com/bindoffice/bind-store/master/.github/logo.svg?sanitize=true)](https://github.com/bindoffice/bind-store)
...
```sh
GO111MODULE=on go get github.com/bindoffice/bind-store
```
...
![Screenshot](https://github.com/bindoffice/bind-store/blob/master/docs/screenshots/minio-browser.png?raw=true)
...
Please follow MinIO [Contributor's Guide](https://github.com/bindoffice/bind-store/blob/master/CONTRIBUTING.md)

# License
Use of MinIO is governed by the Apache 2.0 License found at [LICENSE](https://github.com/bindoffice/bind-store/blob/master/LICENSE).
