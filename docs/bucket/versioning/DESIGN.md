...
A sample msgpack-JSON `xl.meta`, you can debug the content inside `xl.meta` using [xl-meta.go](https://github.com/bindoffice/minio/blob/master/docs/bucket/versioning/xl-meta.go) program.
```json
{
  "Versions": [
    {
