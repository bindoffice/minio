...
- Configure etcd (optional needed only in gateway or federation mode) - [Etcd V3 Quickstart Guide](https://github.com/bindoffice/minio/blob/master/docs/sts/etcd.md)
