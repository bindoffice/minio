...
- Configure etcd (optional needed only in gateway or federation mode) - [Etcd V3 Quickstart Guide](https://github.com/bindoffice/bindstore/blob/master/docs/sts/etcd.md)
