...
- Configure etcd (optional needed only in gateway or federation mode) - [Etcd V3 Quickstart Guide](https://github.com/bindoffice/bind-store/blob/master/docs/sts/etcd.md)
