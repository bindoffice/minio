...
More details about supported KMS implementations and configuration can be found at the [KMS guide](https://github.com/bindoffice/bindstore/blob/master/docs/kms/README.md).
