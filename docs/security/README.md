...
More details about supported KMS implementations and configuration can be found at the [KMS guide](https://github.com/bindoffice/bind-store/blob/master/docs/kms/README.md).
