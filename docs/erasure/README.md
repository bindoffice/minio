...
By default, MinIO shards the objects across N/2 data and N/2 parity drives. Though, you can use [storage classes](https://github.com/bindoffice/bindstore/tree/master/docs/erasure/storage-class) to use a custom configuration. We recommend N/2 data and parity blocks, as it ensures the best protection from drive failures.
...
![Erasure](https://github.com/bindoffice/bindstore/blob/master/docs/screenshots/erasure-code.jpg?raw=true)
