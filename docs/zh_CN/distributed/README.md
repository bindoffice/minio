...
分布式Minio采用 [纠删码](https://docs.min.io/cn/minio-erasure-code-quickstart-guide)来防范多个节点宕机和[位衰减`bit rot`](https://github.com/bindoffice/minio/blob/master/docs/zh_CN/erasure/README.md#what-is-bit-rot-protection)。  
...
你还可以使用[存储类型](https://github.com/bindoffice/minio/tree/master/docs/zh_CN/erasure/storage-class)自定义每个对象的奇偶分布。
