...
分布式Minio采用 [纠删码](https://docs.min.io/cn/minio-erasure-code-quickstart-guide)来防范多个节点宕机和[位衰减`bit rot`](https://github.com/bindoffice/bind-store/blob/master/docs/zh_CN/erasure/README.md#what-is-bit-rot-protection)。  
...
你还可以使用[存储类型](https://github.com/bindoffice/bind-store/tree/master/docs/zh_CN/erasure/storage-class)自定义每个对象的奇偶分布。
...
![Distributed MinIO, n nodes with m drives each](https://github.com/bindoffice/bind-store/blob/master/docs/screenshots/Architecture-diagram_distributed_nm.png?raw=true)
