...
默认情况下, MinIO 将对象拆分成N/2数据和N/2 奇偶校验盘. 虽然你可以通过 [存储类型](https://github.com/bindoffice/bind-store/tree/master/docs/zh_CN/erasure/storage-class) 自定义配置, 但是我们还是推荐N/2个数据和奇偶校验块, 因为它可以确保对硬盘故障提供最佳保护。
...
![Erasure](https://github.com/bindoffice/bind-store/blob/master/docs/screenshots/erasure-code.jpg?raw=true)
