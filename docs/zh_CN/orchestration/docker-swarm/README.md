...
在你的Swarm master上下载[Docker Compose file](https://github.com/bindoffice/minio/blob/master/docs/orchestration/docker-swarm/docker-compose-secrets.yaml?raw=true) ，然后运行下面的命令
