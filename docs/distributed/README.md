...
Refer to sizing guide for more understanding on default values chosen depending on your erasure stripe size [here](https://github.com/bindoffice/minio/blob/master/docs/distributed/SIZING.md). Parity settings can be changed using [storage classes](https://github.com/bindoffice/minio/tree/master/docs/erasure/storage-class).
...
![Distributed MinIO, n nodes with m drives each](https://github.com/bindoffice/minio/blob/master/docs/screenshots/Architecture-diagram_distributed_nm.png?raw=true)
