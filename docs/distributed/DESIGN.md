...
Refer to the sizing guide with details on the default parity count chosen for different erasure stripe sizes [here](https://github.com/bindoffice/bindstore/blob/master/docs/distributed/SIZING.md)
