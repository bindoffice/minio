...
import (
	...
	"github.com/bindoffice/bind-store/cmd/config/etcd"
	"github.com/bindoffice/bind-store/cmd/config/heal"
	...
	"github.com/bindoffice/bind-store/cmd/config/scanner"
	...
	"github.com/bindoffice/bind-store/cmd/logger/target/http"
