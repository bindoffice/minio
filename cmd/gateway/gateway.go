...
import (
	...
	// NAS
	_ "github.com/bindoffice/bindstore/cmd/gateway/nas"

	// Azure
	_ "github.com/bindoffice/bindstore/cmd/gateway/azure"

	// S3
	_ "github.com/bindoffice/bindstore/cmd/gateway/s3"

	// HDFS
	_ "github.com/bindoffice/bindstore/cmd/gateway/hdfs"

	// GCS (use only if you must, GCS already supports S3 API)
	_ "github.com/bindoffice/bindstore/cmd/gateway/gcs"
